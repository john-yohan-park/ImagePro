...
<b>To Run</b>
- Open `MONGO_KEY.js` from the project directory and copy & paste the Mongo Key into the region labeld `PASTE MONGO KEY HERE` (the key has to be a string so keep the single quotes around the key value) 
