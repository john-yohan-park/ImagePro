...
<b>To Run</b>
- Open `MongoKey.js` from the project directory and copy & paste Mongo Key value into the region labeled `'PASTE MONGO KEY HERE'` (keep the single quotes around the key since the key has to be a string) 
