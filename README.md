...
If you have a mac and don't have Node & NPM, open up a terminal and install homebrew (https://brew.sh/). Then run `brew i node`, which installs the latest versions of Node JS and NPM.
